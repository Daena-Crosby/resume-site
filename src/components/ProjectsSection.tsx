...
const projects = [
  {
    ...
    tags: ['React', 'TypeScript', 'UI/UX', 'Web App'],
    icon: BookOpen,
    color: 'primary',
  ...
  },
  {
    ...
    tags: ['Python', 'OpenCV', 'Facial Detection', 'Computer Vision'],
    icon: ScanFace,
    color: 'accent',
  ...
  },
  {
    ...
    tags: ['Python', 'SMTP', 'Automation', 'Email Templates'],
    icon: Mail,
    color: 'accent',
  ...
  },
  {
    ...
    tags: ['React', 'TypeScript', 'UI/UX', 'Interactive'],
    icon: Notebook,
    color: 'accent',
